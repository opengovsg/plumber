/**
 * NOTE: Postman SMS does not support expensive characters in the message body.
 * As the input could come from a variety of sources, we use this __SmartEncodingMap__
 * (that Postman uses) to replace the expensive characters with something that is
 * supported.
 *
 * This is a copy of the __SmartEncodingMap__ from Postman.
 * https://github.com/opengovsg/sgc-msg-segment-cal/blob/develop/src/libs/SmartEncodingMap.ts
 */
