...
export type TFrontEndVariableType = 'text' | 'file_url'

export type TFrontEndVariable = {
  type: TFrontEndVariableType

  name: string
  value: string

  // The stuff in between '{{}}' during variable substitution.
  // E.g. step.b7884840-4911-4547-90e8-61fce24f0e97.fields.647edbd2026dc800116b21f9.answer
...
export interface IApp {
  ...
  /**
   * Gets an ordered array of variables output by an app's step. These variables
   * will potentially be selectable by the user (depending on the variable type
   * and field type) when they are configuring their pipe.
   *
   * @param stepKey - The key associated with the step.
   * @param executionSteps - The execution steps generated by the step,
   *   ordered in descending order of created time.
   */
